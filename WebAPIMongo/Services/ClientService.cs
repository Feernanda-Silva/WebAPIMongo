...
namespace WebAPIMongo.Services
{
    ...
    {
        private readonly IMongoCollection<Client> _clients; //Instalar mongoDb driver
        ...
        public Client GetByName(string name) => _clients.Find<Client>(client => client.Name == name).FirstOrDefault();  
